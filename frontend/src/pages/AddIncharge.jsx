...
const AddIncharge = () => {
    ...
    const { dark, adminlogin, setcommvis } = useContext(AppContext);
                    ...
                    <div className='px-4 sm:px-8 py-6 sm:py-8 border border-gray-700 rounded-xl sm:rounded-2xl w-full max-w-4xl max-h-[80vh] scroller overflow-y-auto'>
                        ...
                        <div className='flex flex-col sm:flex-row items-center sm:items-start gap-4 mb-6 sm:mb-8'>
                            ...
                            <div>
                                ...
                                <p className="text-center sm:text-left text-sm text-gray-500">Picture</p>
                            </div>
                        </div>
                            ...
                            <div className='w-full lg:flex-1 flex flex-col gap-4'>
                                <div className='flex flex-col gap-1'>
                                    ...
                                    <select 
                                        ...
                                        value={work} 
                                        className={`border border-gray-700 rounded px-3 py-2 text-sm sm:text-base ${dark ? "dark" : "light"}`}
                                    >
