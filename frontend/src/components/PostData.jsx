        ...
        <div className={`${dark ? "dark" : "light"} h-screen w-full lg:w-[45%] border border-gray-800 relative`}>
            <div className="overflow-y-scroll w-full scroller h-full relative">
                ...
                <div className="h-fit flex items-center pt-16  lg:pt-7 flex-col gap-8 lg:gap-14 px-2 lg:px-0">
                    <div className="w-full border border-gray-800 rounded-xl lg:rounded-2xl h-fit px-3 sm:px-3.5 py-2.5">
                        ...
                        <div className="flex px-4 sm:px-6 lg:px-11 mt-3 sm:mt-4 lg:mt-5 gap-3 sm:gap-5 lg:gap-8 flex-wrap">
                            ...
                            <div className={(dark ? "text-gray-500" : "text-gray-700") + " flex items-center rounded-xl lg:rounded-3xl cursor-pointer hover:text-green-700 gap-1"}>
                ...
                {(inchargelogin && !verifyImage && (!data.resolvedByIncharge && !data.resolvedByStudent) && inchargeData?.work?.toLowerCase() === data.problem?.toLowerCase()) && (
                    <div className="py-4 px-4 capitalize flex flex-col sm:flex-row gap-3 sm:gap-2 justify-center items-center">
                        ...
                        <input id="verifyImage" type="file" accept="image/*" className="hidden" onChange={(e) => {
                ...
                {verifyImage && (
                    <div className='flex flex-col px-4 sm:px-5 py-4'>
                        ...
                        <div className="py-4 px-4 flex flex-col sm:flex-row gap-4 items-center sm:items-start">
                            <img src={verifyImage} className='h-fit max-h-[200px] sm:max-h-[250px] w-full sm:w-1/2 rounded-lg' alt="Verification proof" />
                            <div className='w-full sm:w-1/2'>
                                <p className='w-full px-4 py-2.5 rounded-xl bg-gray-600 hover:bg-gray-700 font-bold text-white text-center cursor-pointer transition-colors' onClick={verify}>
                                    Submit Verification
                                </p>
                                <p className="text-gray-500 text-sm mt-2">This image will be sent as proof of resolution</p>
                            </div>
                        </div>
                    </div>
                )}
                    ...
                    <div className='flex flex-col px-4 sm:px-5 py-4'>
                        ...
                        <div className="py-4 px-4 flex gap-4 items-center text-gray-500">
                            ...
                            <div>
                                ...
                                <p className="text-sm mt-1">The student confirmed this issue is resolved</p>
                            </div>
                        </div>
                    </div>
                )}
            ...
            {on && (
                <>
                    ...
                    <div className="fixed lg:absolute w-screen lg:w-screen lg:left-[-57%] z-40 h-full top-0 bg-black opacity-70" onClick={() => { seton(false); setcommvis(false); }}></div>
                </>
            )}
        </div>
    )
