    ...
    <div className='pt-10 px-4'>
      <div className='py-2.5 px-3.5 outfit border-1 border-gray-800 rounded-3xl'>
        <div className='flex justify-between'>
          ...
          {dark ? utoken && <i onClick={() => setNotificationOn(true)} className="fi fi-ss-bell text-white text-2xl cursor-pointer"></i> : utoken && <i onClick={() => setNotificationOn(true)} className="fi fi-ss-bell text-2xl cursor-pointer"></i>}
        </div>
      ...
      <div className='py-2.5 px-3.5 outfit text-gray-600 text-sm flex gap-2 mt-4'>
        <a className='text-xs' href="tel:+91 7983704504">+91 7983704504</a>
        <p>|</p> 
        <a href="mailto:campusconnect0611@gmail.com" className='text-xs'>campusconnect0611@gmail.com</a>
        <p>|</p> 
        <a href="#policy" className='text-xs'>policy</a>
      </div>
      <div className='py-2.5 px-3.5 outfit text-gray-600 text-sm flex justify-center'>
        <p>© 2025 CampusX</p>
      </div>
    </div>
   </div>
